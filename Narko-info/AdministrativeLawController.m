...
#import "AdministrativeLawController.h"
#import "DrugLawDetailController.h"

@interface AdministrativeLawController ()

@end

@implementation AdministrativeLawController
...
- (void)viewDidLoad {
    ...
    self.title = @"Адмiнiстративний кодекс";
...
- (void)uploadData {
    ...
    NSString *url_string = [NSString stringWithFormat:@"https://narko-info.space/api/administrative-law"];
...
- (void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender {
    ...
    if([[segue identifier] isEqualToString:@"showDrugLawDetailViewAdministrative"]) {
